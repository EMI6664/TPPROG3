namespace TPPROG3
{
   ...
   this.label1.Text = "Ingresar codigo de repuesto:";
   // 
   // label2
   // 
   ...
   this.label2.Text = "ingresar tipo:";
   // 
   // label3
   // 
   ...
   this.label3.Text = "Ingresar costo:";
   // 
   // label4
   // 
   ...
   this.label4.Text = "ingresar marca del repuesto";
   // 
   // label5
   // 
   ...
   this.label6.Text = "Ingresar stock disponible:";
   // 
   // label7
   // 
   ...
   this.label7.Text = "ingresar punto de pedido:";
   // 
   // label8
   // 
   ...
   this.label8.Text = "Seleccione el repuesto y presione el boton para:";
   // 
   // button1
   // 
   ...
   // button2
   // 
   this.button2.Location = new System.Drawing.Point(545, 315);
   ...
   this.dataGridView1.Location = new System.Drawing.Point(345, 23);
   ...
   // textBox1
   // 
   this.textBox1.Location = new System.Drawing.Point(197, 27);
   ...
   // textBox4
   // 
   this.textBox4.Location = new System.Drawing.Point(197, 147);
   ...
   // textBox5
   // 
   this.textBox5.Location = new System.Drawing.Point(197, 187);
   ...
   // textBox6
   // 
   this.textBox6.Location = new System.Drawing.Point(197, 227);
   ...
   this.Text = "Agregar/Quitar Repuestos";
   this.Load += new System.EventHandler(this.AgregarRepuesto_Load);
