...
namespace TPPROG3
{
 public partial class ModificarDatosEquipo : Form
 {
  ...
  void CargarComboboxTipo(string marca)
  {
   Tablas DATA = new Tablas();
   DATA.CargarCombobox("select * from Tipos_De_Equipo inner join Modelos on Modelos.Cod_TipoE=Tipos_De_Equipo.Cod_TipoE where Marcas.Marca_Nombre=" + "'" + marca + "' and Tipos_De_Equipo.Estado=1", 0, ref cmbx_modelo);
  }
