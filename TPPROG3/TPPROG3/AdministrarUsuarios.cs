...
namespace TPPROG3
{
 public partial class AdministrarUsuarios : Form
 {
  ...
  if(Valid.VerificarLongitudString(txt_nombre_usuario.Text,20)==true){
   ...
   if (Valid.VerificarExistenciaEnTabla(1,txt_nombre_usuario.Text,grd_datos)==true){
   ...
   while (Valid.VerificarExistenciaEnTabla(0, codusuario, grd_datos) == true)
   {
