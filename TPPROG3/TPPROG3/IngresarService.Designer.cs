namespace TPPROG3
{
 partial class IngresarService
 {
  ...
  private void InitializeComponent()
  {
   ...
   this.cmbx_nserie = new System.Windows.Forms.ComboBox();
   this.cmbx_tipo_service = new System.Windows.Forms.ComboBox();
   this.txt_nequipo = new System.Windows.Forms.TextBox();
   this.dtpk_fecha_ingreso = new System.Windows.Forms.DateTimePicker();
   ...
   // cmbx_nserie
   // 
   this.cmbx_nserie.FormattingEnabled = true;
   this.cmbx_nserie.Location = new System.Drawing.Point(160, 76);
   this.cmbx_nserie.Name = "cmbx_nserie";
   this.cmbx_nserie.Size = new System.Drawing.Size(413, 21);
   this.cmbx_nserie.TabIndex = 10;
   // 
   // cmbx_tipo_service
   // 
   ...
   // dtpk_fecha_ingreso
   // 
   this.dtpk_fecha_ingreso.Location = new System.Drawing.Point(160, 129);
   this.dtpk_fecha_ingreso.Name = "dtpk_fecha_ingreso";
   this.dtpk_fecha_ingreso.Size = new System.Drawing.Size(413, 20);
   this.dtpk_fecha_ingreso.TabIndex = 14;
   // 
   // btn_agregar
   // 
   ...
   this.Controls.Add(this.dtpk_fecha_ingreso);
   this.Controls.Add(this.txt_nequipo);
   this.Controls.Add(this.cmbx_tipo_service);
   this.Controls.Add(this.cmbx_nserie);
  ...
  private System.Windows.Forms.ComboBox cmbx_nserie;
  private System.Windows.Forms.ComboBox cmbx_tipo_service;
  private System.Windows.Forms.TextBox txt_nequipo;
  private System.Windows.Forms.DateTimePicker dtpk_fecha_ingreso;
